...
public class BaseStatements {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("For gross ssalary " + grossSalary + " we have nett " + calcNettSalary(grossSalary));
    }
    ...
    public static double calcNettSalaryWithProgressiveScale(double grossSalary) {
        ...
        double taxRate3 = 0.70;

        if (grossSalary * 12 <= 1_000_000) {
            return  grossSalary * (1 - taxRate1);
        } else if (grossSalary * 12 <= 10_000_000){
            return grossSalary * (1 - taxRate2);
        } else if (grossSalary * 12 > 1_000_000_000) {
